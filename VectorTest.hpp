...
#define SUCSESS(arg) std::cout << "      |SUCSESS| " << #arg << std::endl;
#define ERROR(arg) std::cout << "       |ERROR| " << #arg << std::endl;
#define START_GROUP(arg) std::cout << "START TESTING GROUP: " << #arg << std::endl;
#define END_GROUP(arg) std::cout << "END TESTING GROUP: " << #arg << std::endl;
...
#define CHECK(arg) if(arg()) { SUCSESS(arg) } else { ERROR(arg) std::raise(SIGTERM); }
